  ...
  return (
    <div className="relative flex-1 overflow-hidden content-fade-mask">
      <button
        ...
        className={`fixed app-right-6 z-30 size-12 rounded-full bg-muted/80 backdrop-blur-xl flex items-center justify-center shadow-lg ring-1 ring-border/50 transition-all duration-300 ${
