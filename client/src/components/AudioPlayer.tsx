          ...
          <div className="relative">
            ...
            {showSpeedMenu && (
              <div
                ref={speedMenuRef}
                role="menu"
                className="absolute bottom-full mb-2 left-0 z-50 rounded-2xl bg-popover dark:bg-white/10 backdrop-blur-md ring-1 ring-border dark:ring-white/10 shadow-2xl p-1.5 flex flex-col-reverse items-stretch gap-1 animate-in fade-in slide-in-from-bottom-1 duration-150"
                ...
                {speedOptions.map((value) => {
                  ...
                  return (
                    <button
                      ...
                      className={`min-h-[36px] min-w-[56px] px-3 rounded-xl text-xs font-bold leading-none transition-colors active:bg-foreground/10 dark:active:bg-white/15 ${
                        isSelected
                          ? 'bg-[hsl(var(--glow-primary)/0.18)] text-[hsl(var(--glow-primary))]'
                          : 'text-foreground/80 dark:text-white/80 hover:bg-foreground/5 dark:hover:bg-white/10'
                      }`}
