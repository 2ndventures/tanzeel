              ...
              <Sheet open={feedbackOpen} onOpenChange={setFeedbackOpen}>
                ...
                <SheetContent side="bottom" className="h-[55vh] rounded-t-3xl overflow-hidden" style={{ backgroundColor: 'hsl(var(--sheet-bg))', borderColor: 'hsl(var(--sheet-muted))' }}>
                  <div className="absolute inset-0 pointer-events-none">
                    ...
                    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-primary/5 via-transparent to-transparent dark:from-amber-500/8" />
                  </div>
