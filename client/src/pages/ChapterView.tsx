              ...
              <div className="overflow-y-auto overflow-x-hidden flex-1 relative z-10 px-4" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
                ...
                {menuView === 'script' && (
                  <div className="space-y-1">
                    {([
                      { value: 'uthmani' as const, label: 'Uthmani', description: 'Standard Arabic script used in most printed Qurans' },
                      { value: 'indopak' as const, label: 'IndoPak', description: 'Nastaliq-style script common in South Asia' },
                      { value: 'tajweed' as const, label: 'Tajweed', description: 'Color-coded script highlighting tajweed rules' },
                    ]).map((option) => {
